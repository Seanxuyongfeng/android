...
class AllAppsList {
    ...
    //the system application resources
    private static final HashMap<String, Integer> mSystemIcon = new 
		HashMap<String, Integer>(50);
    
    {
	mSystemIcon.put("com.android.cellbroadcastreceiver.CellBroadcastListActivity", R.drawable.ic_broadcast);
	mSystemIcon.put("com.android.browser.BrowserActivity", R.drawable.ic_browser);
	mSystemIcon.put("com.android.calculator2.Calculator", R.drawable.ic_calculator);
	mSystemIcon.put("com.android.calendar.AllInOneActivity", R.drawable.ic_calendar);
	mSystemIcon.put("com.android.camera.CameraLauncher", R.drawable.ic_camera);
	mSystemIcon.put("com.android.contacts.activities.PeopleActivity", R.drawable.ic_contacts);
	mSystemIcon.put("com.mediatek.backuprestore.BootActivity", R.drawable.ic_datatransfer);
	mSystemIcon.put("com.mediatek.datatransfer.BootActivity", R.drawable.ic_datatransfer);
	mSystemIcon.put("com.android.deskclock.DeskClock", R.drawable.ic_deskclock);
	mSystemIcon.put("com.android.providers.downloads.ui.DownloadList", R.drawable.ic_download);
	mSystemIcon.put("com.android.email.activity.Welcome", R.drawable.ic_email);//10
	mSystemIcon.put("com.mediatek.filemanager.FileManagerOperationActivity", R.drawable.ic_filemanager);
	mSystemIcon.put("com.mediatek.FMRadio.FMRadioActivity", R.drawable.ic_fmradio);
	mSystemIcon.put("com.android.gallery3d.app.Gallery", R.drawable.ic_gallerry);
	mSystemIcon.put("com.android.contacts.activities.DialtactsActivity", R.drawable.ic_dialtacts);
	mSystemIcon.put("com.android.mms.ui.BootActivity", R.drawable.ic_message);
	mSystemIcon.put("com.android.music.MusicBrowserActivity", R.drawable.ic_music);
	mSystemIcon.put("com.mediatek.notebook.NotesList", R.drawable.ic_notebook);
	mSystemIcon.put("com.android.quicksearchbox.SearchActivity", R.drawable.ic_quicksearchbox);
	mSystemIcon.put("com.android.soundrecorder.SoundRecorder", R.drawable.ic_recorder);
	mSystemIcon.put("com.android.settings.GridSettings", R.drawable.ic_setting);//20
	mSystemIcon.put("com.mediatek.todos.TodosActivity", R.drawable.ic_todos);
	mSystemIcon.put("com.android.videoeditor.ProjectsActivity", 0);
	mSystemIcon.put("com.mediatek.videoplayer.MovieListActivity", R.drawable.ic_videoplayer);
	mSystemIcon.put("com.mediatek.bluetooth.hid.BluetoothHidActivity", 0);
	mSystemIcon.put("com.android.development.Development", 0);
	mSystemIcon.put("com.mediatek.StkSelection.StkSelection", 0);
	mSystemIcon.put("com.android.settings.Settings$WifiSettingsActivity", 0);//27
	mSystemIcon.put("com.mediatek.taskmanager.TaskManagerPageActivity", R.drawable.ic_launcher_task_manager);
	mSystemIcon.put("com.mediatek.cmcc.MainActivity", R.drawable.ic_customer_service);//
	mSystemIcon.put("cn.wps.moffice.documentmanager.PreStartActivity", 0);//30
	mSystemIcon.put("com.mtk.telephony.HotSwapDevToolActivity", 0);
	mSystemIcon.put("com.mediatek.mobileportal.MobilePortal", R.drawable.ic_mobileportal);
	mSystemIcon.put("com.android.development.Development", 0);
	mSystemIcon.put("com.mediatek.myfavorite.MyFavorite", R.drawable.ic_launcher_myfavorite);
	mSystemIcon.put("com.mediatek.vtdialer.OP01VTDialerActivity", R.drawable.ic_launcher_video_call);//35
	mSystemIcon.put("com.android.stk.StkLauncherActivity", R.drawable.ic_sim);
	mSystemIcon.put("com.mospec.dianeyonline.MainActivity", R.drawable.ic_disney_online);//37
    }
    ...
    /**
      *   
     */
    public static int getSystemAppIcon(String name){
	Integer result = mSystemIcon.get(name);
	int resId = result == null ? 0 : result;
    	return resId;
    }
    ...
    public static int getRandomBackground(){
    	return mRandomBackground[mRandom.nextInt(7)];
    }
