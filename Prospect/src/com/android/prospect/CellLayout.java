...
public class CellLayout extends ViewGroup implements View.OnClickListener, Page{
    ...
    public CellLayout(Context context, AttributeSet attrs, int defStyle) {
 	...
 	mBackground = res.getDrawable(R.drawable.homescreen_holo_light);
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        if(action == MotionEvent.ACTION_UP){
        	if(mLauncher.isLaunchTag()){
        		mLauncher.launchTag(false);
        		return true;
        	}
        }
