...
public class DeleteDropTarget extends ButtonDropTarget {
    ...
    private boolean isAllAppsApplication(DragSource source, Object info) {
        return (source instanceof AppsCustomizePagedView || source instanceof TabAppsPagedView) && (info instanceof ApplicationInfo);
    }
    ...
    private boolean isAllAppsWidget(DragSource source, Object info) {
        if (source instanceof AppsCustomizePagedView || source instanceof TabWidgetsPagedView) {
