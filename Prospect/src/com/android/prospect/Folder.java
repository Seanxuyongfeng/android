...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener,
    ...
    /// M: Margin right of the unread text related to its parent.
    ...
    public Folder(Context context, AttributeSet attrs) {
        ...
        /// M: added for Unread feature, initialize the variable of mUnreadMarginRight.
        mUnreadMarginRight = (int)context.getResources().getDimension(R.dimen.folder_unread_margin_right);
    }
    ...
    protected boolean createAndAddShortcut(ShortcutInfo item) {
        ...
        final MTKShortcut shortcut =
            (MTKShortcut) mInflater.inflate(R.layout.folder_application/*mtk_application*/, this, false);        
    ...
    private void updateItemLocationsInDatabase() {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            LauncherModel.moveItemInDatabase(mLauncher, info, mInfo.id, mInfo != null ? mInfo.screen : 0,
	...
	if(currentPage > mLauncher.getWorkspace().getPageCount() - 1){
		currentPage = mLauncher.getWorkspace().getPageCount() - 1;
	}
    ...
    private void arrangeChildren(ArrayList<View> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if (info.cellX != vacant[0] || info.cellY != vacant[1]) {
                info.cellX = vacant[0];
                info.cellY = vacant[1];
                LauncherModel.addOrMoveItemInDatabase(mLauncher, info, mInfo.id, mInfo != null ? mInfo.screen : 0,
                        info.cellX, info.cellY);
            }
            boolean insert = false;
            ...
            public void run() {
               ...
               View child = null;
                ...
                if (getItemCount() == 1) {
                    ...
                    child = mLauncher.createShortcut(R.layout.mtk_application, cellLayout,
                            finalItem);
    ...
    public void onAdd(ShortcutInfo item) {
        ...
        LauncherModel.addOrMoveItemInDatabase(
                mLauncher, item, mInfo.id, mInfo != null ? mInfo.screen : 0, item.cellX, item.cellY);
    }
