...
import com.android.prospect.FolderInfo.FolderListener;
...
public class FolderIcon extends LinearLayout implements FolderListener {
    ...
    private static final float INNER_RING_GROWTH_FACTOR = 0.0f;//0.15f;

    // The degree to which the outer ring is scaled in its natural state
    private static final float OUTER_RING_GROWTH_FACTOR = 0.1f;//0.3f;
    ...
    /// M: add for unread events feature.
    ...
    static FolderIcon fromXml(int resId, Launcher launcher, ViewGroup group,
        ...
        /// M: added fro unread feature.
        icon.mUnread = (TextView) icon.findViewById(R.id.folder_unread);
        LauncherLog.d(TAG, "fromXml icon.mUnread = " + icon.mUnread);
