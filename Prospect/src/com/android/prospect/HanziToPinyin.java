...
public class HanziToPinyin {
    ...
    public String getTokensForSearch(final String input, StringBuilder offsets) {
        ...
        for (int i = 0; i < inputLength; i++) {
            ...
            if (character == '-' || character == ',') {
            ...
            } else if (character >= FIRST_RUSSIAN_UPPER && character <= LAST_RUSSIAN_LOWER) {
                ...
                caseTypeCurr = (character >= FIRST_RUSSIAN_UPPER && character <= LAST_RUSSIAN_UPPER) ?
                        DialerSearchToken.UPPERCASE
                        : DialerSearchToken.LOWERCASE;
