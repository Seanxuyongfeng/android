...
public class InstallShortcutReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_INSTALL_SHORTCUT = "com.android.prospect.action.INSTALL_SHORTCUT";
    ...
    private static final String EXTRA_SHORTCUT_INTENT_ARRAY = "com.android.prospect.extra.shortcut.array.INTENT";
    private static final String EXTRA_SHORTCUT_NAME_ARRAY = "com.android.prospect.extra.shortcut.array.NAME";
    private static final String EXTRA_SHORTCUT_ICON_ARRAY = "com.android.prospect.extra.shortcut.array.ICON";
    private static final String EXTRA_SHORTCUT_ICON_RESOURCE_ARRAY = "com.android.prospect.extra.shortcut.array.ICON_RESOURCE";
    private static final String EXTRA_SHORTCUT_TOTAL_NUMBER = "com.android.prospect.extra.shortcut.totalnumber";
    private static final String EXTRA_SHORTCUT_STEP_NUMBER = "com.android.prospect.extra.shortcut.stepnumber";

    // A mime-type representing shortcut data
    public static final String SHORTCUT_MIMETYPE = "com.android.prospect/shortcut";
        ...
        if (findEmptyCell(context, items, tmpCoordinates, screen)) {
            if (intent != null) {
                ...
                if (duplicate || !shortcutExists) {
                    ...
                    if (info == null) {
                        result[0] = INSTALL_SHORTCUT_ADD_FAIL;
                        LauncherLog.e(TAG, "InstallShortcut Failed: Due to ShortcutInfo is null");
                        return false;
                    }
                    ...
                    LauncherLog.e(TAG, "InstallShortcut Failed: Already Exist!");
                    result[0] = INSTALL_SHORTCUT_IS_DUPLICATE;
                }
            ...
            LauncherLog.e(TAG, "InstallShortcut Failed: No Space!");
