...
public class LauncherProvider extends ContentProvider {
    ...
    static final String AUTHORITY = "com.android.prospect.settings";
   ...
   static final String TABLE_APPLICATIONS = "applications";
    ...
    public static final String LOAD_ALL_APPS_TO_DATABASE_NEEDED = "LOAD_ALL_APPS_TO_DATABASE_NEEDED";
    static final String DEFAULT_WORKSPACE_RESOURCE_ID =
            "DEFAULT_WORKSPACE_RESOURCE_ID";

    private static final String ACTION_APPWIDGET_DEFAULT_WORKSPACE_CONFIGURE =
            "com.android.prospect.action.APPWIDGET_DEFAULT_WORKSPACE_CONFIGURE";
    ...
    private static long dbInsertAndCheck(DatabaseHelper helper,
        ...
        if (table.equals(TABLE_FAVORITES) && !values.containsKey(LauncherSettings.Favorites._ID)) {
    ...
    synchronized public void loadDefaultFavoritesIfNecessary(int origWorkspaceResId) {
        ...
        if (sp.getBoolean(DB_CREATED_BUT_DEFAULT_WORKSPACE_NOT_LOADED, false)) {
            ...
            sOpenHelper.loadScene(sOpenHelper.getWritableDatabase(), R.xml.default_workspace);
            editor.commit();
        }
    }
    ...
    static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            if(LauncherFeature.SEARCH_WIDGET){
	            ...
	            db.execSQL("CREATE TABLE " + TABLE_APPLICATIONS + " ("+
	                    ...
	                    "sort_key" + " TEXT," +
	                    "sort_key_alt" + " TEXT COLLATE_NOCASE," +                    
	                    "normalized_name" + " TEXT COLLATE_NOCASE DEFAULT NULL," +      
	                    "data_offsets" + " VARCHAR DEFAULT NULL," + 
	                    "name_index" + " TEXT," + 
        ...
        private void setFlagToLoadAllApps(){
            String spKey = LauncherApplication.getSharedPreferencesKey();
            SharedPreferences sp = mContext.getSharedPreferences(spKey, Context.MODE_PRIVATE);
            SharedPreferences.Editor editor = sp.edit();
            editor.putBoolean(LOAD_ALL_APPS_TO_DATABASE_NEEDED, true);
            editor.commit();
        }
        ...
        public void loadScene(SQLiteDatabase db, int workspaceResourceId) {
            if (LauncherLog.DEBUG) {
                LauncherLog.d(TAG, "loadScene: workspaceResourceId = " + workspaceResourceId);
            }
            ...
            try {
                ...
                while (((type = parser.next()) != XmlPullParser.END_TAG ||
                    ...
                    name = parser.getName();
                    if (LauncherLog.DEBUG) {
                        LauncherLog.d(TAG, "loadScene: name = " + name);
                    }
                    if (name.equals(new String(TAG_SCENE))) {
                        ...
                        if (LauncherLog.DEBUG) {
                            LauncherLog.d(TAG, "loadScene: sceneOfXml = " + sceneOfXml);
                        }
                    }
                    ...
                    if (name.equals(new String(TAG_WALLPAPER))) {
                        ...
                        if (LauncherLog.DEBUG) {
                            LauncherLog.d(TAG, "LauncherProvider.loadScene sceneOfXml = "
                                    + sceneOfXml + ", wallpaper = " + wallpaper);
                        }
