...
public class PagedViewCellLayout extends ViewGroup implements Page {
	...
	TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.TabAppsPagedView, 0, 0);
        int cellWidth = a.getDimensionPixelSize(R.styleable.TabAppsPagedView_cellWidth, 0);
	if(cellWidth != 0){
        ...
        int cellHeight = a.getDimensionPixelSize(R.styleable.TabAppsPagedView_cellHeight, 0);
	if(cellHeight != 0){
    ...
    public void calculateCellCount(int width, int height, int maxCellCountX, int maxCellCountY) {
        ...
        mCellCountY = 5;//Math.min(maxCellCountY, estimateCellVSpan(height));
        if (LauncherLog.DEBUG_LAYOUT) {
