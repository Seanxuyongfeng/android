...
public class SearchDropTargetBar extends FrameLayout implements DragController.DragListener {
    ...
    public void showSearchBar(boolean animated) {
        if (!mIsSearchBarHidden || !LauncherFeature.SEARCH_BAR_SUPPORT) return;
        if (animated) {
            prepareStartAnimation(mQSBSearchBar);
            mQSBSearchBarAnim.reverse();
        } else {
    ...
    public void onDragStart(DragSource source, Object info, int dragAction) {
        ...
        if (!mIsSearchBarHidden && LauncherFeature.SEARCH_BAR_SUPPORT) {
            prepareStartAnimation(mQSBSearchBar);
            mQSBSearchBarAnim.start();
        }
    }
    ...
    public void onSearchPackagesChanged(boolean searchVisible, boolean voiceVisible) {
        ...
        if (LauncherFeature.SEARCH_BAR_SUPPORT && mQSBSearchBar != null) {
