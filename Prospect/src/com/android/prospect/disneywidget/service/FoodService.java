...
import com.android.prospect.disneywidget.remoteviewfactory.FoodFactory;
...
public class FoodService  extends RemoteViewsService { 
	private static final String TAG="MyWidgetService";
    @Override
    public RemoteViewsFactory onGetViewFactory(Intent intent) { 
        
        return (RemoteViewsFactory) new FoodFactory(this.getApplicationContext(), intent); 
    } 
