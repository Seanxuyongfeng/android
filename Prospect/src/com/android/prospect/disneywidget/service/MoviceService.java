...
import com.android.prospect.disneywidget.remoteviewfactory.MoviceFactory;
...
public class MoviceService  extends RemoteViewsService { 
	private static final String TAG="MyWidgetService";
    @Override
    public RemoteViewsFactory onGetViewFactory(Intent intent) { 
    	return (RemoteViewsFactory)new MoviceFactory(this.getApplicationContext(), intent);
    } 
